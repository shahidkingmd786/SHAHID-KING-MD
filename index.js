            ...
            try {
                ...
                if (mek.key && mek.key.remoteJid) {
                    await conn.sendMessage(mek.key.remoteJid, { 
                        text: 'PATHAN BOT: Oops! An error occurred while processing your message.',
                        contextInfo: {
                            forwardingScore: 1,
                            isForwarded: false,
...
│     *World Best SHAHID KING* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing SHAHID KING!* 
...
├─ 🌟 *GitHub:*  
│    https://github.com/shahidkingmd786/SHAHID-KING-MD  
╰─🚀 *Powered by SHAHID KING-MD*        
`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: false,
